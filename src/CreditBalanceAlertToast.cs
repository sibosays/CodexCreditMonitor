...
internal sealed class CreditBalanceAlertToast : Form
{
    private readonly System.Windows.Forms.Timer _dismissTimer = new() { Interval = 12_000 };

    public CreditBalanceAlertToast(decimal credits)
    {
        ...
        var title = NewLabel(Ui.T("SALDOWAARSCHUWING", "BALANCE WARNING"), 9, FontStyle.Bold, Color.FromArgb(177, 198, 223));
